...
Module DataEnvironment_DataEnvironment3_Module
	Friend DataEnvironment3 As DataEnvironment_DataEnvironment3 = New DataEnvironment_DataEnvironment3()
End Module

Friend Class DataEnvironment_DataEnvironment3
	...
	Public Sub New()
		...
		m_Command1.CommandText = "`customer`"
